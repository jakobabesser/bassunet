# source: https://raw.githubusercontent.com/yselivonchyk/Tensorflow_WhatWhereAutoencoder/master/pooling.py
...
class MaxPoolingWithArgmax2D(Layer):
    ...
    def compute_output_shape(self, input_shape):
        # ratio = (1, 2, 2, 1)
        ratio = (1, self.pool_size[0], self.pool_size[1], 1)    # todo check
        output_shape = [
            dim // ratio[idx]
...
class MaxUnpooling2D(Layer):
    def __init__(self, up_size=(1, 4), **kwargs):
